...
public class DefaultTaskManagerTest {
    ...
    void testMaxCap() throws ReflectiveOperationException {
        TaskManager taskManager = TaskManagerRegistry.create(TaskManagerRegistry.DefaultTaskManager.name(), 10L);
    ...
    void testMaxCapReached() throws ReflectiveOperationException {
        TaskManager taskManager = TaskManagerRegistry.create(TaskManagerRegistry.DefaultTaskManager.name(), 5L);
        ...
        Process ignored = taskManager.addProcess(Priority.HIGH);
        ...
        Assertions.assertEquals(3, shouldNotIgnore.pid);
    }
