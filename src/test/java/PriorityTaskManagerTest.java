...
public class PriorityTaskManagerTest {
    ...
    void testMaxCap() throws ReflectiveOperationException {
        TaskManager taskManager = TaskManagerRegistry.create(TaskManagerRegistry.PriorityTaskManager.name(), 10L);
    ...
    void testMaxCapReached() throws ReflectiveOperationException {
        TaskManager taskManager = TaskManagerRegistry.create(TaskManagerRegistry.PriorityTaskManager.name(), 5L);
    ...
    @Test
    void testMaxCapReached2() throws ReflectiveOperationException {
        TaskManager taskManager = TaskManagerRegistry.create(TaskManagerRegistry.PriorityTaskManager.name(), 5L);
        ...
        Process ignore = taskManager.addProcess(Priority.LOW);
        Assertions.assertNull(ignore);
    }
